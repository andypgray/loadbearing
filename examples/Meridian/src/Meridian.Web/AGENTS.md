...
This directory holds the `Web` layer. Web is the HTTP surface of the monolith: the controllers, their request and response models, and the data access behind them. Its architecture rules:
