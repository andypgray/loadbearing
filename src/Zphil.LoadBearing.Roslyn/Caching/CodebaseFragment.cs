...
///     SymbolId, construction edges by source then constructed) so serialization is stable; global ordering
///     is re-derived at merge, so a fragment's internal order never affects the model.
/// </remarks>
