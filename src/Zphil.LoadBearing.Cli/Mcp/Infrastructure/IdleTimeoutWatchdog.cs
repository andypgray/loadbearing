...
internal static class IdleTimeoutWatchdog
{
    ...
    ///     in-flight call finish before tearing the process down. Calls parked on an outer filter have
    ///     not yet reached <see cref="EnterCall" />, so they are correctly uncounted.
    /// </summary>
