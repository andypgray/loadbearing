...
///     anchor is an <see cref="AttributeAnchor" />, so the string form renders the identical prefix.
///     <para>
...
///     </para>
/// </summary>
internal sealed class MemberAttributedWithAdjective(AttributeAnchor anchor) : MemberAdjective
{
