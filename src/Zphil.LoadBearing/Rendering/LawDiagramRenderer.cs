...
public static class LawDiagramRenderer
{
    ...
    // property of the spec, so a wrong fence is a wrong rule and not a stale render. Em-dash-free by
    // construction — the caption sits outside the fence, which makes it prose in the docs it lands in.
