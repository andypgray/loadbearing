...
/// <summary>An immutable, reusable set of types the spec talks about (GRAMMAR §3).</summary>
/// <remarks>
///     A closed class hierarchy: the constructor is <c>private protected</c>, so foreign assemblies
///     cannot introduce selection nodes, and every node in the model is walkable and renderable by
