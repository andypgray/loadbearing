...
///     already editing a baselined file (GRAMMAR §5.4).
/// </summary>
/// <remarks>
///     <see cref="MigrateIfSmall" /> is the default when <c>.WhileYoureThere(...)</c> is omitted
///     (GRAMMAR §4.4), and it must be the zero value so the reified default is deterministic.
/// </remarks>
