...
/// </summary>
/// <remarks>
///     LoadBearing's own enum — deliberately NOT <c>Microsoft.CodeAnalysis.TypeKind</c>; Roslyn must
///     not enter Core. Records are expressed via the escape hatch in v1.
/// </remarks>
