...
public class AgentContextRendererTests
{
    ...
    {
        ArchitectureModel model = ArchModelBuilder.Build(new CtorRuleSpec());
    ...
    {
        ArchitectureModel model = ArchModelBuilder.Build(new UseAndCtorRuleSpec());
    ...
    private sealed class UseAndCtorRuleSpec : IArchitectureSpec
    {
        public void Define(Arch arch)
        {
            arch.Rule("time/inject-clock")
