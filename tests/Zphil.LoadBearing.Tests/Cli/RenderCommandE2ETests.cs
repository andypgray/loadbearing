...
///     <c>--diagram</c> adds the Mermaid codebase graph as a target of its own, scopeable by project-name
///     glob and refusing its scope options when no target file is named.
/// </summary>
[Collection("Serial")]
