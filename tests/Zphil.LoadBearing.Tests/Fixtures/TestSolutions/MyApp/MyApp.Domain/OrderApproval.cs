...
// Applies order rules. Throwing the domain's own OrderRuleViolation is sanctioned (green); the
// throw new System.InvalidOperationException(...) is a BCL throw — the red site for
// exceptions/domain-throws-domain. No Web reference, so the layering rules stay clean.
