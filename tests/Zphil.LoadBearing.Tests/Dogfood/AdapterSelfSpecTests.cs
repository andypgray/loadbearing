...
/// <summary>
///     The adapter dogfood (Phase 7 acceptance box 3): LoadBearing's own self-spec, run through the xUnit
...
///     checked universe, exactly as the CLI self-check does.
/// </summary>
[Collection("Serial")]
public sealed class AdapterSelfSpecTests : ArchRuleTests<LoadBearingArchSpec>
{
    protected override string SolutionPath => RepoRoot.Solution;
}