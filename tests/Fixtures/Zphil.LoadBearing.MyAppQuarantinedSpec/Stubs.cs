...
///     <c>typeof(IBillingFacade)</c> compiles in the quarantined spec; correspondence to the real MyApp type
///     is by full name (the established Stubs pattern). This DLL is not a MyApp solution member, so the
///     stub never enters the checked universe.
/// </summary>
